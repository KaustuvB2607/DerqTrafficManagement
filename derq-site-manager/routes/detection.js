...
const getAllDetectionList = require("../services/getAllDetectionList");
const getDetectionBySiteId = require("../services/getDetectionBySiteId");
...
/* GET list of Detection data for a given Site id */
...
(req, res) => {
    ...
    if(!siteId) {
      ...
      getDetectionBySiteId(siteId, res);
    }
});
